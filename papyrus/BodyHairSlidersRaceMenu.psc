...
;
; Modern RaceMenu uses BodyHairSliders' C++ SKEE wrapper backend. SKEE v1
; uses RaceMenu's stable NiOverride Papyrus natives instead of the incompatible
; v1 C++ ABI. RaceMenu 0.4.19.14 on Skyrim 1.6.640 has been observed exposing v1.
